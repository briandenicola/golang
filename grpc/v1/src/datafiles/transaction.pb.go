...
func (*TransactionRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_transaction_d222dd16202150d8, []int{0}
}
...
func (*TransactionResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_transaction_d222dd16202150d8, []int{1}
}
...
func init() { proto.RegisterFile("transaction.proto", fileDescriptor_transaction_d222dd16202150d8) }

var fileDescriptor_transaction_d222dd16202150d8 = []byte{
